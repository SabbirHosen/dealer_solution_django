...
urlpatterns = [
    ...
    path('customer-dues-details/<str:phone>/', views.CustomerDuesDetails.as_view(), name='customer-dues-details'),
    path('api/customer-info/', views.api_customer_info, name='customer-info-api'),
    path('retailer-business-status/api/<str:status>/<str:time_period>', views.RetailerBusinessStatusData.as_view(),
         name='retailer-business-status-data-api'),
    path('retailer-collection/', views.RetailerCollection.as_view(), name='retailer-collection'),
    path('retailer-collection-from-dues/<str:phone>/', views.RetailerCollectionFromDues.as_view(),
