...
class CustomUser(AbstractUser):
    ...
    def get_role(self):
        if self.is_superuser:
            ...
            return "retailer"
        elif self.is_direct_retailer:
            return "direct_retailer"
        elif self.is_sales_representative:
            return "sales_representative"
        elif self.is_delivery_sales_representative:
            return "delivery_sales_representative"
        elif self.is_dealer:
            return "dealer"
...
class UserInformation(UserTimeStampMixin):
    ...
    photo = models.ImageField(
        upload_to="user", null=True, blank=True, default="profile.png"
    )
